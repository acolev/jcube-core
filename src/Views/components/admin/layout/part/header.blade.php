  ...
  <div class="layout-width">
    <div class="navbar-header">
      ...
      <div class="d-flex align-items-center">
        ...
        @if(isset($topBarRight)) {{ $topBarRight }} @endif
          ...
          <div class="dropdown ms-sm-3 header-item topbar-user">
            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
              ...
              <span class="d-flex align-items-center">
                <img class="rounded-circle header-profile-user" src="{{ getImage('assets/admin/images/profile/'.$user->image, '400x400') }}" alt="Header Avatar">
                <span class="text-start ms-xl-2">
                  <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ implode(' ', [$user->name, $user->last_name]) }}</span>
