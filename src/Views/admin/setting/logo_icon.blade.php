    ...
    <div class="row mb-none-30">
        <div class="col-md-12 mb-30">
            <div class="card bl--5-primary">
                <div class="card-body">
                    <p class="text--primary">@lang('If the logo and favicon are not changed after you update from this page, please')
                                    ...
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload1"
                                                   class="bg--primary">@lang('Logo For White Background')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload3"
                                                   class="bg--primary">@lang('Logo For Dark Background')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
