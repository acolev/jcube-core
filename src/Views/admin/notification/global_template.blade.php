                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <x-form.html type="full" name="email_template" :value="$general->email_template"/>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" placeholder="@lang('SMS Body')"
                                              name="sms_body" required>{{ $general->sms_body }}</textarea>
                                </div>
                            </div>
                        </div>
